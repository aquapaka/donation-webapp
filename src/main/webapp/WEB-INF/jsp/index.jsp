...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/indexScripts.js"></script>
...
<body>
    ...
    <main class="container-fluid p-0 position-relative">
        ...
        <section id="introduction" class="container py-2 my-3 py-md-5 my-md-5">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="${pageContext.request.contextPath}/donation-events"><button class="btn btn-primary">Quyên góp ngay</button></a>
                </div>
                <div class="col-md-6">
        ...
        <!-- Donation Event -->
        <jsp:include page="components/donationEventsSection.jsp"/>
